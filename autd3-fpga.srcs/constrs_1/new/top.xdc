...
set_input_delay -clock cpu_bsc_75M -max 1.5 [get_ports CPU_WE0_N]
set_input_delay -clock cpu_bsc_75M -min 0.5  [get_ports CPU_CS1_N]
set_input_delay -clock cpu_bsc_75M -max 1.5 [get_ports CPU_CS1_N]
set_input_delay -clock cpu_bsc_75M -min 0.5 [get_ports CPU_DATA*]
set_input_delay -clock cpu_bsc_75M -max 1.5 [get_ports CPU_DATA*]
set_input_delay -clock cpu_bsc_75M -min 0.5 [get_ports CPU_ADDR*]
set_input_delay -clock cpu_bsc_75M -max 1.5 [get_ports CPU_ADDR*]
set_output_delay -clock cpu_bsc_75M -min 0.5 [get_ports CPU_DATA*]
set_output_delay -clock cpu_bsc_75M -max 1.5 [get_ports CPU_DATA*]

create_clock -period 39.062 -name main_25P6M -waveform {0.000 19.531} [get_ports MRCC_25P6M]
set_false_path -from [get_ports CAT_SYNC0] -to [all_registers]
set_false_path -from [get_clocks main_25P6M] -to [get_ports FORCE_FAN]
set_false_path -from [get_clocks main_25P6M] -to [get_ports XDCR_OUT*]
